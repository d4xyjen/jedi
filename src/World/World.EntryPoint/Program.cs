...
namespace Jedi.World.EntryPoint
{
    ...
    public class Program
    {
        ...
        {
            new WorldEntryPoint<Startup>().Run(args);
        }
    }

    /// <summary>
    /// World service entry point.
    /// </summary>
    /// <typeparam name="TStartup">The type of the startup object.</typeparam>
    internal class WorldEntryPoint<TStartup> : EntryPoint<TStartup> where TStartup : class, IAppStartup
    {
        /// <summary>

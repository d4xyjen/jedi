...
namespace Jedi.Zone.EntryPoint
{
    /// <summary>
    ...
    public class Program
    {
        ...
        {
            new ZoneEntryPoint<Startup>().Run(args);
        }
    }

    /// <summary>
    /// Zone service entry point.
    /// </summary>
    /// <typeparam name="TStartup">The type of the startup object.</typeparam>
    internal class ZoneEntryPoint<TStartup> : EntryPoint<TStartup> where TStartup : class, IAppStartup
    {
        /// <summary>

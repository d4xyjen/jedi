...
namespace Jedi.Game.EntryPoint
{
    /// <summary>
    ...
    public class Program
    {
        ...
        {
            new GameEntryPoint<Startup>().Run(args);
        }
    }
    ...
    internal class GameEntryPoint<TStartup> : EntryPoint<TStartup> where TStartup : class, IAppStartup
    {
        /// <summary>
